...
class Storage {
  constructor(conn, attr) {
    this.conn = conn;
    this.ref = new rp.remote_storage(attr);
  }
}
...
Storage.prototype.poolLookupByUuid = function(uuid, callback) {
  ...
  let promise = new Promise((resolve, reject) => {
    ...
    this.conn.request(proc.REMOTE_PROC_STORAGE_POOL_LOOKUP_BY_UUID(), data.toXDR(), (err, payload) => {
...
Storage.prototype.poolLookupByName = function(name, callback) {
  ...
  let promise = new Promise((resolve, reject) => {
    let cb = (e, r) => (e) ? reject(e) : resolve(r);
    this.conn.request(proc.REMOTE_PROC_STORAGE_POOL_LOOKUP_BY_NAME(), data.toXDR(), (err, payload) => {
      if (err) { cb(err, null); return; }
...
Storage.prototype.poolLookupByVolume = function(vol, callback) {
  ...
  let promise = new Promise((resolve, reject) => {
    let cb = (e, r) => (e) ? reject(e) : resolve(r);
    this.conn.request(proc.REMOTE_PROC_STORAGE_POOL_LOOKUP_BY_VOLUME(), data.toXDR(), (err, payload) => {
      if (err) { cb(err, null); return; }
...
Storage.prototype.volLookupByName = function(pool, name, callback) {
  ...
  let promise = new Promise((resolve, reject) => {
    let cb = (e, r) => (e) ? reject(e) : resolve(r);
    this.conn.request(proc.REMOTE_PROC_STORAGE_VOL_LOOKUP_BY_NAME(), data.toXDR(), (err, payload) => {
      if (err) { cb(err, null); return; }
...
Storage.prototype.volLookupByKey = function(key, callback) {
  ...
  let promise = new Promise((resolve, reject) => {
    let cb = (e, r) => (e) ? reject(e) : resolve(r);
    this.conn.request(proc.REMOTE_PROC_STORAGE_VOL_LOOKUP_BY_KEY(), data.toXDR(), (err, payload) => {
      if (err) { cb(err, null); return; }
...
Storage.prototype.volLookupByPath = function(path, callback) {
  ...
  let promise = new Promise((resolve, reject) => {
    let cb = (e, r) => (e) ? reject(e) : resolve(r);
    this.conn.request(proc.REMOTE_PROC_STORAGE_VOL_LOOKUP_BY_PATH(), data.toXDR(), (err, payload) => {
      if (err) { cb(err, null); return; }
